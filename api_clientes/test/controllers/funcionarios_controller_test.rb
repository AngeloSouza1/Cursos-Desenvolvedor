...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { dta_nascimento: @funcionario.dta_nascimento, nome: @funcionario.nome, registro: @funcionario.registro } }, as: :json
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { dta_nascimento: @funcionario.dta_nascimento, nome: @funcionario.nome, registro: @funcionario.registro } }, as: :json
    assert_response :success
  end
